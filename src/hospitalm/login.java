...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CENTER HOSPITAL ");

        jLabel5.setFont(new java.awt.Font("Century", 2, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("NICE TREATMENT");

        jLabel7.setFont(new java.awt.Font("Century", 2, 14)); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/doctor (3).png"))); // NOI18N
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        try {
            ...
            PreparedStatement log = con.prepareStatement("select *from doctor where username = '" + username.getText() + "'and password = '" + password.getText() + "'");
            r = log.executeQuery();
            if (r.next()) {
